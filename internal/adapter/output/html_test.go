...
func TestWriteHTML(t *testing.T) {
	rpt := &report.Report{
		Metadata: report.Metadata{Host: "localhost", Port: 5432, ToolVersion: "test"},
		Summary:  report.Summary{Total: 2, Passed: 1, Failed: 1, BySeverity: map[string]int{"WARNING": 1}},
		Categories: []report.CategoryReport{
			{
				...
				Checks: []report.CheckReport{
					...
					{ID: "1.2", Title: "Fail Check", Status: "FAIL", Severity: "WARNING",
						Messages: []report.MsgEntry{{Level: "FAILURE", Content: "Something wrong"}}},
				},
			},
		},
	}
