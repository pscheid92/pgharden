...
func TestWriteText(t *testing.T) {
	rpt := &report.Report{
		Summary: report.Summary{Total: 3, Passed: 1, Failed: 1, Skipped: 1, BySeverity: map[string]int{"WARNING": 1}},
		Categories: []report.CategoryReport{
			{
				ID:    "1",
				Title: "Installation",
				Checks: []report.CheckReport{
					{ID: "1.1", Title: "Check One", Status: "PASS", Messages: []report.MsgEntry{{Level: "SUCCESS", Content: "All good"}}},
					{ID: "1.2", Title: "Check Two", Status: "FAIL", Severity: "WARNING", Messages: []report.MsgEntry{{Level: "FAILURE", Content: "Bad config"}}},
