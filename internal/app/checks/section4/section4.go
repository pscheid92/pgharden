...
func (c *check_4_1) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
...
func (c *check_4_3) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
...
func (c *check_4_4) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
...
func (c *check_4_5) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
	rows, err := env.DB.Query(ctx, `
...
func (c *check_4_6) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
	rows, err := env.DB.Query(ctx, `
...
func (c *check_4_7) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
	rows, err := env.DB.Query(ctx, `
...
func (c *check_4_8) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
	rows, err := env.DB.Query(ctx, `
...
func (c *check_4_10) Run(ctx context.Context, env *domain.Environment) (*domain.CheckResult, error) {
	var nspacl *string
